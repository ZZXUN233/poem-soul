...
诗魂是 Android 应用「行箸（XingZhu）」的 Web 伴侣。复用其已清洗的离线语料，在网页上提供**诗卷浏览、全文检索、诗词阅读**等基础功能，并为后续 **AI 玩法**（格律 / 平仄 / 韵脚赏析、智能问答）预留入口。
...
- 📚 **书架**：诗卷概览 + 按朝代 / 体裁筛选浏览，分页
- 🔍 **全文检索**：标题、作者、正文匹配，命中字段高亮 + 上下文片段，支持朝代 / 体裁过滤，结果可分享（URL 驱动 `/search?q=…`）
- 📖 **阅读**：`/poem/<id>` 展示单首诗词完整正文与元信息
- ✨ **诗魂 AI**（占位）：`/ai` 预留后续玩法入口
